...
namespace SdlDotNetExamples.SpriteGuiDemos
{
    ...
    public class StatusWindow : GuiWindow
    {
        ...
        public override void Update(TickEventArgs args)
        {
            ...
            //			if (SpriteGuiDemosMain.IsFull)
            //			{
            //				fps.TextString = 
            //					SpriteGuiDemosMain.Fps.FramesPerSecond.ToString("#0.00", CultureInfo.CurrentCulture);
            //			}
            //			else
            //			{
            //				fps.TextString = "---";
            ...
            if (SpriteGuiDemosMain.CurrentDemo == null)
            {
                mode.Text = "<none>";
            }
            else
            {
                mode.Text = SpriteGuiDemosMain.CurrentDemo.ToString();
            }
        }
        #endregion
