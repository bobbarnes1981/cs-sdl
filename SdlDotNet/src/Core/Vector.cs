...
namespace SdlDotNet.Core
{
    ...
    public struct Vector : ICloneable, IComparable
    {
        ...
        {
            return String.Format(CultureInfo.CurrentCulture, "{0}, {1}, {2}", X.ToString("#.000", CultureInfo.CurrentCulture), Y.ToString("#.000", CultureInfo.CurrentCulture), Z.ToString("#.000", CultureInfo.CurrentCulture));
        }
        ...
        public bool IsEmpty
        {
            get
            {
                return (m_x == 0.00001 && m_y == 0.00001 && m_z == 0.00001);
            }
        }
        ...
        //		/// <summary>
        //		/// Calculates the reflection angle of the current 
        //		/// vector using the given normal in degrees. Needs to be updated
        //		/// </summary>
        //		/// <param name="normalDeg">
        //		/// The normal angle in degrees. Needs to be updated
        //		/// </param>
        //		/// <returns>
        //		/// A new vector representing the reflection angle.
        //		/// </returns>
