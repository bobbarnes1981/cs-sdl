...
namespace MezzanineLib.World
{
	...
	{
		public const int MAX_MIP = 5;   // 32x32 unit blocks
		public const int MIN_LOD = 2;
		public const int LOW_LOD = 25;
		public const int MAX_LOD = 1000;

		public static int lod = 40;
		public static int lodtop;
		public static int lodbot;
		public static int lodleft;
		public static int lodright;
		public static int min_lod;
		
		public static bool render_floor;
		public static bool render_ceil;
	}
}
