...
namespace MezzanineLib.Game
{
	...
	/// 
	/// </summary>
	public sealed class SaveGameDemo
	{
		public static bool demorecording = false;
		public static bool demoloading = false;
		static int islittleendian = 1;
		public static int IsLittleEndian
		{
			get
			{
