struct fpsserver : igameserver
{
    ...
    char *servername() { return "Mezzanineserver"; };
    int serverinfoport() { return Mezzanine_SERVINFO_PORT; };
    int serverport() { return Mezzanine_SERVER_PORT; };
    char *getdefaultmaster() { return "Mezzanine.org/masterserver/"; }; 
