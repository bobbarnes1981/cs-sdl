...
namespace SdlDotNet
{
	...
	/// </summary>
	[Serializable]
	public class Vector2D : ISerializable, ICloneable, IComparable
	{
		...
		{
			return new Vector2D(c1.m_x + c2.m_x, c1.m_y + c2.m_y);
		}
		...
		{
			return new Vector2D(a + b.m_x, a + b.m_y);
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			double len = this.Length;
			return new Vector2D(m_x / len, m_y / len);
		}
		...
		public Vector2D(SerializationInfo info, StreamingContext ctxt)
		{
		...
		public int CompareTo(object obj)
		{
			...
			throw new ArgumentException("object is not a Vector2D");    
		}
