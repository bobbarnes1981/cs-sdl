...
namespace SdlDotNet.Sprites
{
	...
	public class ImageCollectionDrawable : IDrawable
	{
		...
		/// <summary>
		/// Load from SurfaceCollection
		/// </summary>
		/// <param name="collection"></param>
		public ImageCollectionDrawable(SurfaceCollection collection)
		{      
		...
		public Surface this[int frame]
		{
			get 
			{ 
				return (Surface) frames[(int) frame % frames.Count]; 
			}
		}
