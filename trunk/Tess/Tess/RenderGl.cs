...
namespace Tess
{
	class RenderGl
	{
		...
		internal static void GlInit(int w, int h)
		{
...
//		}
		...
		static void TransPlayer()
		{
			...
			Gl.glRotated(Tess.Player1.roll,0.0,0.0,1.0);
			Gl.glRotated(Tess.Player1.pitch,-1.0,0.0,0.0);
			Gl.glRotated(Tess.Player1.yaw,0.0,1.0,0.0);

			Gl.glTranslated(-Tess.Player1.o.x, (Tess.Player1.state==(int)CSStatus.CS_DEAD ? Tess.Player1.eyeheight-0.2f : 0)-Tess.Player1.o.z, -Tess.Player1.o.y);   
		}
	}
}
