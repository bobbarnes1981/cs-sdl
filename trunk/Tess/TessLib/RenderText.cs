...
namespace TessLib
{
	public class RenderText
	{
		...
		static RenderText()
		{
			...
			short[,] char_coords;
			char_coords = new short[,] {{0,0}};
			//char_coords[1] = new short[][] {{25,0,54,6}};
			//char_coords = new short[,,] {{0,0,25}, {25,0,54}};
		}
//			 =
//					  {
//	{0,0,25,64}, //!
...
//	}
		...
		public static int text_width(string str)
		{
			int x = 0;
