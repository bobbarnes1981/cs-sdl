...
class EighthFlipRenderer extends CardRenderer {
	...
	public function getSettings () {
		...
		$settings = array_merge($settings, $rendererSections['config-eighth.txt']['fonts - regular']);
		$settings = array_merge($settings, $rendererSections['config-eighth.txt']['layout - flip']);
		return $settings;
	}
}
