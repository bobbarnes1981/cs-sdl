...
namespace SdlDotNetExamples.SpriteGuiDemos
{
    ...
    public class GuiMode : DemoMode
    {
        ...
        public GuiMode()
        {
            ...
            GuiManager manager = SpriteGuiDemosMain.GuiManager;
            ...
            if (threshold > 1.0)
            {
                ...
                switch (rand.Next() % 5)
                {
                    case 0: // Switch autohide
                        if (ticker.IsAutoHide)
                        {
                            ticker.Add(new TextSprite("AutoHide off",
                                SpriteGuiDemosMain.GuiManager.BaseFont));
                        }
                        else
                        {
                    ...
                    case 1: // Simple message
                        // Add a message
                        ticker.Add(new TextSprite("*tick*", SpriteGuiDemosMain.GuiManager.BaseFont));
                        break;
                    case 2: // Bunch of messages
                        ticker.Add(new TextSprite("*", SpriteGuiDemosMain.GuiManager.BaseFont));
                        ticker.Add(new TextSprite("*", SpriteGuiDemosMain.GuiManager.BaseFont));
                        ticker.Add(new TextSprite("*", SpriteGuiDemosMain.GuiManager.BaseFont));
                        ticker.Add(new TextSprite("*", SpriteGuiDemosMain.GuiManager.BaseFont));
                        ticker.Add(new TextSprite("*", SpriteGuiDemosMain.GuiManager.BaseFont));
