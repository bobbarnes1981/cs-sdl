...
final class JoglRenderer extends JoglDriver implements refexport_t, Ref {
	 ...
	 * 
	 */
	public void displayChanged(GLAutoDrawable drawable, boolean change1, boolean change2)
	{}
	
	       /**
         * 
         */
        public void reshape(GLAutoDrawable drawable, int change1, int change2, int change3, int change4)
        {}
